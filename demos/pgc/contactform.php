...
$formproc->AddRecipient('innovatests@gmail.com'); //<<---Put your email address here
...
<!-- <div class='short_explanation'>Please don’t hesitate to contact us if you have any questions or comments.</div> -->
...
<div class='container'>
    ...
    <textarea rows="10" cols="80" name='message' id='message'><?php echo $formproc->SafeDisplay('message') ?></textarea>
</div>

<div class='container submit bluebg'>
